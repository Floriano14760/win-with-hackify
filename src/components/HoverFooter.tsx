      ...
      <div className="relative z-10">
        <div className="section-container py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            {/* Brand & Description - GEO optimized */}
            ...
            {/* Expertise Keywords - GEO optimized */}
            <div>
              <h2 className="font-display font-semibold text-foreground mb-4 text-sm uppercase tracking-wider">
              ...
              <ul className="space-y-3">
                <li className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    aria-label="Envoyer un email à HACKIFY"
                  >
                    {contactInfo.email}
                  </a>
                </li>
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="text-muted-foreground hover:text-primary transition-colors text-sm"
                    aria-label="Prendre rendez-vous avec HACKIFY sur Calendly"
                  >
                    Prendre rendez-vous
                  </a>
                </li>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Suivre HACKIFY sur LinkedIn"
              ...
              <span className="text-muted-foreground text-xs">
                Cabinet français · Données hébergées en France
              </span>
            </div>
