      ...
      <div className="section-container" ref={ref}>
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className={`body-lg transition-all duration-700 delay-100 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
            }`}>
              Nous ne sommes pas une simple agence de rédaction. HACKIFY est un partenaire 
              stratégique qui comprend les enjeux business et transforme chaque appel d'offres 
