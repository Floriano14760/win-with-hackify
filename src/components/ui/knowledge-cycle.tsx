...
function getLabelPositionClasses(position: ProcessStep["position"]) {
  switch (position) {
    ...
    case "right":
      return "top-1/2 -translate-y-1/2 -right-24 sm:-right-28";
    case "bottom":
      return "-bottom-14 left-1/2 -translate-x-1/2";
    case "left":
      return "top-1/2 -translate-y-1/2 -left-24 sm:-left-28";
  }
}
  ...
  return (
    <div className="flex items-center justify-center w-full h-full p-8 sm:p-12">
      <div className="relative w-[180px] h-[180px] sm:w-[220px] sm:h-[220px]">
        {/* Central rotating arrows circle */}
            ...
            <div key={step.id}>
              ...
              <div
                className={cn(
                  ...
                  getLabelPositionClasses(step.position)
                )}
              >
        ...
        {/* Connecting arrows - simplified curved paths */}
        <svg
